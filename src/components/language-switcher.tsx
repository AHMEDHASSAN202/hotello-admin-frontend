...
/**
 * EN ⇄ العربية switcher (Story 7.2). Available on every page including login.
 *
 * `persist` writes the choice to the admin profile so it follows them across
 * devices — pass `persist={false}` on the pre-login pages, where the cookie is
 * the only store available.
 */
