/**
 * Single source of truth for the admin dashboard's locales.
 *
 * Reusability (Epic 07, note 9): the Tenant Dashboard (AR/EN) and later the
 * Guest App (7 languages) reuse this module. Only this file lists the locales —
